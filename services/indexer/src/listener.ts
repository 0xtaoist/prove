...
// Program IDs
const PROGRAMS = {
  BatchAuction: new PublicKey("BAuc1111111111111111111111111111111111111111"),
  FeeRouter: new PublicKey("FeeR1111111111111111111111111111111111111111"),
  StakeManager: new PublicKey("Stak1111111111111111111111111111111111111111"),
  TickerRegistry: new PublicKey("Tick1111111111111111111111111111111111111111"),
  ProveAMM: new PublicKey("PAMM1111111111111111111111111111111111111111"),
} as const;
